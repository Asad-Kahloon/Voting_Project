...
const ViewConstituency = () => {
  ...
  return (
    <main className="main-container table">
      <Link to="/superadmin/addconstituency" className="table-btn">
        Add +
      </Link>
      <table>
        <thead>
          ...
          {constituencys.map((constituency) => {
            return (
              <tr key={constituency.id}>
                ...
                <td>
                  <Link
                    to={`/superadmin/form45/${constituency._id}`}
                ...
                <td>
                  <Link
                    to={`/superadmin/updateconstituency/${constituency._id}`}
                    className="table-btn edit"
                  >
                    Edit
                  </Link>
                  <Link
                    to={`/superadmin/deleteconstituency/${constituency._id}`}
